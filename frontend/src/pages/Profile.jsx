...
function Profile() {
  ...
  if (error) {
    return (
      <div className="text-center mt-10 p-6 bg-red-100 border border-red-400 text-red-700 rounded-lg max-w-lg mx-auto">
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-md mx-auto bg-white shadow-lg rounded-xl p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          <img
            src={user?.profilePicture ? `${BACKEND_BASE}${user.profilePicture}` : "https://upload.wikimedia.org/wikipedia/commons/2/2c/Default_pfp.svg"}
            alt="Profile"
